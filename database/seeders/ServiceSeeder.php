...
class ServiceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Service::create([
            ...
            'logo_url' => 'http://localhost:8000/images/icons/icon5.svg',
            'color_hex' => '#f3faff',
        ]);
    }
}
